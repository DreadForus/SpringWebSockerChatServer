package com.example.websocketdemo.security.endpoint;
...
public class MessageMappingEndpoint {
	...
	public WebSocketMappings mappings() {
		...
		Map<SimpMessageMappingInfo, HandlerMethod> messageHandlerMethods = this.filterByAnnotation(handler.getHandlerMethods(), MessageMapping.class);
		Map<SimpMessageMappingInfo, HandlerMethod> subscribeHandlerMethods = this.filterByAnnotation(handler.getHandlerMethods(), SubscribeMapping.class);
	...
	private List<HandlerMapping> extractMapping(Map<SimpMessageMappingInfo, HandlerMethod> handlerMethods) {
	...
	private Map<SimpMessageMappingInfo, HandlerMethod> filterByAnnotation(Map<SimpMessageMappingInfo, HandlerMethod> handlerMethods, Class<? extends Annotation> annotation) {
